    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                //validations
                //our focus is on register module
                if (userName.isEmpty()) {
                ...
                User user = new User(userName, userEmail, userPassword, userPhone, "none", userAddress,"normal");

                Session hibernatesession = factoryprovider.getfaFactory().openSession();
